...
hero.querySelector('h1').innerHTML = 'One pool.<br>One shared climb.'
hero.querySelector('.hero__copy > p:not(.eyebrow)').textContent = 'Our reserve is the XMR in our MONEROCHAN liquidity pool. Watch it move with trading and compare its size with holder balances. One pool, one shared climb.'
